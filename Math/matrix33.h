...
private:
	...
	double determinant2x2(double matrix[4]);
};
...
inline void rotateX(Matrix33& m, double angle)
{
	m[0][0] = 1.0f;
	m[0][1] = 0.0f;
	m[0][2] = 0.0f;
...
inline void rotateY(Matrix33& m, double angle)
{
	m[0][0] = cos(angle);
	m[0][1] = 0.0f;
	m[0][2] = -sin(angle);
...
inline void rotateZ(Matrix33& m, double angle)
{
	m[0][0] = cos(angle);
	m[0][1] = sin(angle);
	m[0][2] = 0.0f;
...
inline void rotate(Matrix33& m, const Vector3& v, double angle)
{
...
inline void scale(Matrix33& m, double factorx, double factory, double factorz)
{
...
inline void scale(Matrix33& m, const Vector3& v, double factor)
{
...
inline Matrix33 operator* (double scalar, Matrix33& m1)
{
	return Matrix33(
...
inline Matrix33 operator* (Matrix33& m1, double scalar)
{
	return Matrix33(
		m1[0][0]*scalar, m1[0][1]*scalar, m1[0][2]*scalar, 
		m1[1][0]*scalar, m1[1][1]*scalar, m1[1][2]*scalar, 
